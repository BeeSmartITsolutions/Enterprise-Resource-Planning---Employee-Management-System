...
echo'<center><table cellpadding="5" cellspacing="0" width="80%"><FORM NAME="XYZ"  ACTION ="salary.php" method="post">
<tr><td>        <input type="text" name="search_item" id="search1" placeholder="Search by Salary">
...
$rs=mysql_query("select*from ems_employee where emp_salary = '$item'");
